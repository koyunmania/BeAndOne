...
<body onLoad="init();window.scroll(0, 150)">
			...
			<div class="col-md-10">
				...
				<div class="row">
					<div class="col-md-7" ng-controller="HappeningCtrl" ng-init="initHappenings()">
						<h2 id="happenings-header"><spring:message code="label.today"/></h2>
					...
					<div class="col-md-5">
						<div style="float: right;">
							<select id="locale" onchange="translatePageLang(this.id)">
								<option value="en">English</option>
								<option value="tr">Turkish</option>
							</select>
						</div>
						<h2 id="experiences-header"><spring:message code="label.diary"></spring:message></h2>
						<div class="panel panel-default" ng-controller="ExperienceCtrl" ng-init="initExperience()">
							<div class="panel-heading"><spring:message code="label.diary.submessage"></spring:message>?</div>
						...
						<h2 id="experiences-header"><spring:message code="label.daily.questions"></spring:message></h2>
						<div id="myCarousel" class="carousel slide" data-ride="carousel">
							...
							<div ng-controller="QuestionAnswerCtrl" ng-init="initQuestionAnswer('${selectedDate}')" class="carousel-inner" role="listbox">
								<div class="item panel panel-default active">
									<div class="panel-heading"><spring:message code="label.daily.learning"></spring:message>?</div>
									<div class="panel-body">
									<c:if test="${usersCurrentDate.equals(selectedDate)}">
										<form>
								...
								<div class="item panel panel-default">
									<div class="panel-heading"><spring:message code="label.daily.wish"></spring:message>?</div>
									<div class="panel-body">
									<c:if test="${usersCurrentDate.equals(selectedDate)}">
										<form>
											<textarea class="form-control" rows="2" cols="30"

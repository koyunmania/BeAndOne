...
INSERT INTO users (username, email, password, firstname, lastname, birthday, gender, currentcityid, provider, createdat, updatedat) VALUES 
	('engingokten', 'engin@beone.com', '1234', 'Engin', 'G&ouml;kten', '1981-01-01', 'Male', (SELECT cityid FROM city WHERE cityname='Istanbul'), 'beone', now(), now());
INSERT INTO users (username, email, password, firstname, lastname, birthday, gender, currentcityid, provider, createdat, updatedat) VALUES 
	('selcukbeyhan', 'selcuk@beone.com', '1234', 'Selcuk', 'Beyhan', '1981-01-01', 'Male', (SELECT cityid FROM city WHERE cityname='Istanbul'), 'beone', now(), now());
INSERT INTO users (username, email, password, firstname, lastname, birthday, gender, currentcityid, provider, createdat, updatedat) VALUES 
	('user1', 'user1@beone.com', '1234', 'User 1', 'Test', '1981-01-01', 'Male', (SELECT cityid FROM city WHERE cityname='Istanbul'), 'beone', now(), now());
